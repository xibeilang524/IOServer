...
BEGIN_MESSAGE_MAP(CConfigPage, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_BUTTON_ACCE, &CConfigPage::OnBnClickedButtonAcce)
END_MESSAGE_MAP()
...
void CConfigPage::OnButtonDelsel() 
{
...
void CConfigPage::OnButtonExport() 
{
	// TODO: Add your control notification handler code here
...
void CConfigPage::OnButtonInport() 
{
	// TODO: Add your control notification handler code here
	/*
...
BOOL CConfigPage::AddInPortTag(LPCTSTR sz0,LPCTSTR sz1,LPCTSTR sz2,LPCTSTR sz3,LPCTSTR sz4,LPCTSTR sz5,LPCTSTR sz6)
{
	CTagItem tag;
	tag.m_szName = sz0; 
...
void CConfigPage::OnButtonExsamp() 
{
	// TODO: Add your control notification handler code here
	/*
	CFileDialog	dlg(FALSE,_T(".csv"),NULL,
...
LRESULT CConfigPage::OnDblClkWinList(WPARAM wParam, LPARAM lParam)
{
...
//加速配置
void CConfigPage::OnBnClickedButtonAcce()
{
	// TODO: 在此添加控件通知处理程序代码
	CDlgAcceCfg dlg;
