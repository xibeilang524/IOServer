...
$Archive: /PI/clients/pilogin/pilogex.h $

-------------------------------------------------------------------------------

Copyright (c) 1995-1998 OSI Software, Inc. All rights reserved. 
...
$Log: /PI/clients/pilogin/pilogex.h $

2     9/08/98 10:05a Charlie
New copyright information.
    
  1     1/29/97 7:40a Harry  
  Initial check-in of pilogin code - version 1.3.2  

Migrated Previous History
 Date       Author  Description
 07-Sep-95  hks  Change #if defined(_WINDOWS) to _WINDOW || _WIN32 for 32 bit
                 Change FAR PASCAL to PIPROC Change __far to PIPTR
 20-Sep-95  hks/rcv Added ERR_LOGIN_USERNOTFOUND for odbcloginfo
 21-Sep-95  hks/rcv Modified return comments to agree with changed source,
                    see pilogin.cpp changes on this date
 06-Nov-95  hks     Change #define function names to lowercase for 32 bit.
 29-Dec-95  hks     Added PIPROC to EXPORTXXX defines to get _stdcall
 30-Jul-96  hks     Added ERR_NO_PILOGIN_REG  
 01-Aug-96  hks     New error codes for pilg_addnewserver.  Add 
                    pilg_addnewserver2 for installshield problem.
 *---------------------------------------------------------------------
 * 
 *    Rev 1.23   30 Aug 1995 11:56:12   Brian Bostwick
 * Quite a few changes stemming from the removal of PIINT32 as a typedef.
 * 
 *    Rev 1.22   25 Aug 1995 16:20:34   Brian Bostwick
 * Added the valid login status parameter to pilg_setpassword and
 * pilg_getodbcinfo.
 * 
 *    Rev 1.21   22 Aug 1995 18:59:02   Scott Webber
 * Changed function declarations to use generic #defines based on _WIN32 flag.
 * 
 *    Rev 1.20   22 Aug 1995 16:02:54   Brian Bostwick
 * Merged in 1.17.1.0.
 * 
 *    Rev 1.19   16 Aug 1995 14:01:02   Scott Webber
 * Added #ifdef's to handle differences between 16-Bit 'FAR PASCAL _export' 
 *    and '__declspec( dllimport )'
 * 
 *    Rev 1.18   14 Aug 1995 09:12:32   Yves Picquendar 
 * No change.
 * 
 *    Rev 1.17   31 Jul 1995 16:51:46   Zahid Moghal
 * Defined keywords and declarations for prototypes and data types according
 * to OSI instructions for cross platform prtability.
 * 
 *    Rev 1.16   14 Apr 1995 13:31:38   Tim Brien
 * Added GetAvailableServer & AddNewServer functions
 * 
 *    Rev 1.15   08 Feb 1995 11:23:14   Zack Miloushev
 * Added ODBC login info API
 * 
 *    Rev 1.14   14 Nov 1994 15:49:22   Zack Miloushev
 * Cosmetic function prototype changes.
 * 
 *    Rev 1.13   08 Nov 1994 11:01:16   Zack Miloushev
 * Export functions name change
 * 
 *    Rev 1.12   04 Nov 1994 15:43:52   Zack Miloushev
 * Added new export function - PiRegisterHelp
 * 
 *    Rev 1.11   03 Oct 1994 13:10:38   Zack Miloushev
 * Comments changed.
 * 
 *    Rev 1.10   01 Sep 1994 12:57:44   Zack Miloushev
 * Comments change
 * 
 *    Rev 1.9   25 Aug 1994 12:22:10   Zack Miloushev
 * Return code of PiGetNodeId changed
 * 
 *    Rev 1.8   19 Aug 1994 15:35:00   Zack Miloushev
 * Enhancements, corrections
 * 
 *    Rev 1.7   17 Aug 1994 16:43:54   Zack Miloushev
 * New error codes added
 * 
 *    Rev 1.6   09 Aug 1994 19:05:56   Zack Miloushev
 * Disconnect from a single PI server added
 * 
 *    Rev 1.5   04 Aug 1994 09:50:00   Zack Miloushev
 * #define FAILURE - taken out, Comments changed
 * 
 *    Rev 1.4   03 Aug 1994 14:43:30   Zack Miloushev
 * Added PiGetNodeId entry, Added field to TAGLIST struct
 * 
 *    Rev 1.3   02 Aug 1994 11:19:02   Zack Miloushev
 * Added TagSearch & PointAttr Dialogs
 * 
 *    Rev 1.2   22 Jul 1994 13:28:28   Zack Miloushev
 * New pilogin.dll entry points
 * 
 *    Rev 1.1   20 Jul 1994 17:04:40   Zack Miloushev
