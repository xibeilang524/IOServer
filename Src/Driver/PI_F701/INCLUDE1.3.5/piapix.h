...
$Log: /pi/freeze/intel/piapi/piapix.h $

31    2/17/07 11:18a Jeggleston

35    9/08/06 8:22a Dcoda
Merge with piapi1.6 branch - point attr cache, pilogsrv message
transfer to pimesslog feature, 64-bit platform compatibility.

36    8/25/06 12:09p Driddell
Modified for Point Caching

33    06-02-09 10:45 Charlie
Move netgetpointsourcelong to doclient.h from piapix.h.

32    06-01-23 14:42 Charlie
Eliminate 1.6.0.x UNIX compilation warnings.

31    5/18/05 5:40p Ssortland

30    2/14/05 4:42p Ssortland
Added piut_isconnected

29    1/05/05 5:14p Ssortland
piut_setappidentity implemented

28    12/29/04 7:41p Ssortland
