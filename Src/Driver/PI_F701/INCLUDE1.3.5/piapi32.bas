...
' 
' 22    2/17/07 11:18a Jeggleston
' 
' 18    2/10/06 2:33p Dcoda
' Added declarations for pipt_descriptorx(), pipt_exdescx(),
' pipt_instrumenttagx(), and pipt_tagnamex() for new functions in
' 1.4.0.x.
'
...
Declare Function pipt_descriptorx Lib "piapi32.dll" (ByVal pt&, ByVal desc$, slen&) As Long
...
Declare Function pipt_exdescx Lib "piapi32.dll" (ByVal pt&, ByVal exdesc$, slen&) As Long
...
Declare Function pipt_instrumenttagx Lib "piapi32.dll" (ByVal pt&, ByVal instrumenttag$, slen&) As Long
...
Declare Function pipt_tagnamex Lib "piapi32.dll" (ByVal pt&, ByVal tag$, slen&) As Long
