...
$Log: /pi/freeze/intel/piapi/piapi.h $

23    2/17/07 11:18a Jeggleston

31    1/25/07 1:47p Driddell
Add functionality to disconnected startup to call pipt_digcode and
retrieve cached digcode given a passed digital string that had
previously been cached.

30    9/08/06 8:16a Dcoda
Merge with piapi1.6 branch - point attr cache, pilogsrv message
transfer to pimesslog feature, 64-bit platform compatibility.

31    8/25/06 12:09p Driddell
Modified for Point Caching

28    5/18/05 5:40p Ssortland

27    5/03/05 4:55p Ssortland
...
These are now  the only functions which will return the entire tag
attribute, no matter how long. Previously the existing functions had
been modified to return the longer results, but this caused problems
when programs did not correctly handle a -411 status - which had been a
valid but rarely seen return code.

26    2/15/05 2:24p Ssortland
Modified pitm_servertimeutc to return fractions of a second

25    2/09/05 2:16p Ssortland
pipt_signupforupdatesfil basics complete.

24    1/31/05 2:33p Ssortland
Getting long point attributes full implementation 

23    1/05/05 7:32p Ssortland
pitm_servertimeutc and pitm_fastservertimeutc implemented

22    11/18/04 4:57p Ssortland
Port to PI 3.4.370 version of piut

21    11/04/04 12:44p Ssortland
Code Cleanup: Removed mostly redundant WINDOWS platform. Now just have
Win32.

20    11/04/04 11:36a Ssortland
Code Clean up: Removed the  DOS platform
