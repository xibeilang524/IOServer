...
public:
	...
	BOOL GetPrivateBuild(LPTSTR lpszPrivateBuild, int nSize);
	BOOL GetSpecialBuild(LPTSTR lpszSpecialBuild, int nSize);
...
protected:
	...
	TCHAR		m_szPrivateBuild[MAX_PATH*2];
	TCHAR		m_szSpecialBuild[MAX_PATH*2];
};
