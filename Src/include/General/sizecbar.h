...
class _GENERAL_CLASS CSCBButton
{
public:
    CSCBButton();

    void Move(CPoint ptTo) {ptOrg = ptTo; };
    CRect GetRect() { return CRect(ptOrg, CSize(12, 12)); };//原为11,蒋勇改为12
    void Paint(CDC* pDC);
...
class _GENERAL_CLASS CSCBDockBar : public CDockBar
{
...
class _GENERAL_CLASS CSizingControlBar : public baseCSizingControlBar
{
