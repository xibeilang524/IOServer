...
void CTabSheet::SetRect()
{
	...
	if (m_bHideTab)	nPos = 24;

	m_pPages[0]->SetWindowPos(&wndTop, nX, nY - nPos, nXc, nYc + nPos, SWP_SHOWWINDOW);
	for (int nCount = 1; nCount < m_nNumOfPages; nCount++)
		m_pPages[nCount]->SetWindowPos(&wndTop, nX, nY - nPos, nXc, nYc + nPos, SWP_HIDEWINDOW);
