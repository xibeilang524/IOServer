...
//////////////////////////////////////////////////////////////////////////////
// MeasureItem
void CColorListBox::MeasureItem(LPMEASUREITEMSTRUCT)
{
}

//////////////////////////////////////////////////////////////////////////////
// CompareItem
int CColorListBox::CompareItem(LPCOMPAREITEMSTRUCT)
{
	return 0;
}
...
int CColorListBox::GetTextWithColor(int nIndex, LPTSTR lpszBuffer) const
{
	if (!::IsWindow(m_hWnd))
	{
		ASSERT(FALSE);
...
//////////////////////////////////////////////////////////////////////////////
// GetTextWithColor - get text string with color bytes
void CColorListBox::GetTextWithColor(int nIndex, CString& rString) const
{
	if (!::IsWindow(m_hWnd))
	{
		ASSERT(FALSE);
...
int CColorListBox::GetText(int nIndex, LPTSTR lpszBuffer) const
{
	if (!::IsWindow(m_hWnd))
	{
		ASSERT(FALSE);
...
//////////////////////////////////////////////////////////////////////////////
// GetText - for compatibility with CListBox (no color bytes)
void CColorListBox::GetText(int nIndex, CString& rString) const
{
	if (!::IsWindow(m_hWnd))
	{
		ASSERT(FALSE);
...
int CColorListBox::GetTextLen(int nIndex) const
{
	if (!::IsWindow(m_hWnd))
	{
		ASSERT(FALSE);
...
//////////////////////////////////////////////////////////////////////////////
// SearchString
int CColorListBox::SearchString(int nStartAfter, LPCTSTR lpszItem, BOOL bExact) const
{
	if (!::IsWindow(m_hWnd))
	{
		ASSERT(FALSE);
...
//////////////////////////////////////////////////////////////////////////////
// FindString
int CColorListBox::FindString(int nStartAfter, LPCTSTR lpszItem) const
{
...
//////////////////////////////////////////////////////////////////////////////
// SelectString
int CColorListBox::SelectString(int nStartAfter, LPCTSTR lpszItem)
{
...
//////////////////////////////////////////////////////////////////////////////
// FindStringExact
int CColorListBox::FindStringExact(int nStartAfter, LPCTSTR lpszItem) const
{
...
{
	return AddLine(CColorListBox::Black, CColorListBox::White, lpszItem);
}

//////////////////////////////////////////////////////////////////////////////
// AddLine
int CColorListBox::AddLine(Color tc, Color bc, LPCTSTR lpszLine)
{
	if (!::IsWindow(m_hWnd))
	{
		ASSERT(FALSE);
...
///////////////////////////////////////////////////////////////////////////////
// Printf
void _cdecl CColorListBox::Printf(Color tc, Color bc, UINT nID, LPCTSTR lpszFmt, ...)
{
...
//////////////////////////////////////////////////////////////////////////////
// EnableColor
void CColorListBox::EnableColor (BOOL bEnable)
{
	m_bColor = bEnable;
}
...
//////////////////////////////////////////////////////////////////////////////
// SetTabPosition
void CColorListBox::SetTabPosition(int nSpacesPerTab)
{
...
//////////////////////////////////////////////////////////////////////////////
// GetVisibleLines
int CColorListBox::GetVisibleLines()
{
	int nCount = 0;
...
//////////////////////////////////////////////////////////////////////////////
// SetFont
void CColorListBox::SetFont(CFont *pFont, BOOL bRedraw)
{
	if (!::IsWindow(m_hWnd))
	{
		ASSERT(FALSE);
...
void CColorListBox::OnContextMenu(CWnd* /*pWnd*/, CPoint point)
{
	...
	TRACE(_T("CColorListBox::OnContextMenu: m_nContextMenuId=%d\n"), m_nContextMenuId);
	if (m_nContextMenuId == -1)
	{
		if (menu.CreatePopupMenu())
		{
			// 默认菜单
			menu.AppendMenu(MF_POPUP | MF_BYPOSITION | MF_STRING, ID_EDIT_SELECT_ALL, _T("全选(&S)"));
			menu.AppendMenu(MF_POPUP | MF_BYPOSITION | MF_STRING, ID_EDIT_COPY, _T("拷贝(&C)"));
			menu.AppendMenu(MF_POPUP | MF_BYPOSITION | MF_STRING, ID_EDIT_CLEAR, _T("清除(&L)"));

			menu.TrackPopupMenu(0, point.x, point.y, this, NULL);
...
//////////////////////////////////////////////////////////////////////////////
// OnEditSelectAll
void CColorListBox::OnEditSelectAll()
{
	if (!::IsWindow(m_hWnd))
	{
		ASSERT(FALSE);
